...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-info">
            <a class="navbar-brand" href="index.php"><img src="https://www.wardahbeauty.com/assets/images/logo.png" alt="" width="170px"></a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-sm">
                        <p><a class='btn btn-info rounded-pill' href="forminput.php">[+] Tambah baru</a></p>
                            <table class="table table-bordered table-info text-center mt-4 mb-5">
